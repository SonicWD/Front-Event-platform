        ...
        <form onSubmit={handleSubmit(onSubmit)} className="form space-y-6">
          <div>
            ...
            <input
              ...
              className={`input w-full p-2 border rounded ${errors.username ? 'border-red-600' : 'border-gray-300'} dark:${errors.username ? 'border-red-600' : 'border-gray-700'}`}
              {...register('username')}
            />
          ...
          <div className="relative">
            ...
            <input
              ...
              id="password"
              placeholder="*********"
              className={`input w-full p-2 border rounded ${errors.password ? 'border-red-600' : 'border-gray-300'} dark:${errors.password ? 'border-red-600' : 'border-gray-700'}`}
              {...register('password')}
            />
            <button
              type="button"
